...
export const siteConfig: SiteConfig = {
  ...
  ghlCalendarId: 'Vpx0VAcSU1GM0M87NXOm',
  ...
  testimonials: {
    ...
    items: [
      {
        quote: 'La Doctora Clara Uribe es una excelente profesional, su empatía y calidez humana marcan la diferencia. Me ayudó muchísimo en mi proceso de pareja; estaba a punto de una separación y ahora estamos nuevamente muy bien con mi esposo. Es una Psicóloga excepcional al 100%.',
        author: 'S***a R.',
      ...
      {
        quote: 'Excelente profesional. La doctora brinda una atención muy humana, respetuosa y clara. Su evaluación fue profunda y cuidadosa, y logró comprender el contexto emocional y familiar con mucha sensibilidad.',
        author: 'D***y L.',
        date: '24 de abril de 2026',
        stars: 5,
      },
      {
        quote: 'Excelente profesional, un ambiente agradable. Te orienta en el proceso, da solución y proyección, con carácter y mucho amor.',
        author: 'E***n O.',
        date: '17 de junio de 2026',
        stars: 5,
      },
      {
        quote: 'Super recomendada, muy amable con los niños. Excelente informe detallado. Te brinda estrategias adecuadas para el manejo de tu condición.',
        author: 'M***a M.',
        date: '24 de mayo de 2026',
        stars: 5,
      },
      {
        quote: 'Clara es una gran psicóloga. Desde el primer momento me hizo sentir tranquilo y en confianza. Escucha con mucha empatía y se nota que le importa realmente ayudar. La recomiendo totalmente.',
        author: 'D***l P.',
        date: '24 de noviembre de 2025',
        stars: 5,
      },
      {
        quote: 'Desde el primer encuentro, nos hizo sentir escuchados y comprendidos, y creó un espacio seguro y acogedor para mi hijo. Su enfoque es muy profesional, empático y adaptado a cada caso.',
        author: 'A***e G.',
